...
SorcerUI::SorcerUI() {
  { window = new Fl_Double_Window(515, 450);
    ...
    { lfoBox = new Avtk::Box(182, 157, 152, 75);
      lfoBox->box(FL_DOWN_BOX);
      lfoBox->color(FL_BACKGROUND_COLOR);
      lfoBox->selection_color(FL_BACKGROUND_COLOR);
      lfoBox->labeltype(FL_NO_LABEL);
      lfoBox->labelfont(0);
      lfoBox->labelsize(14);
      lfoBox->labelcolor(FL_FOREGROUND_COLOR);
      lfoBox->align(Fl_Align(FL_ALIGN_CENTER));
      lfoBox->when(FL_WHEN_RELEASE);
      //lfoBox->color( fl_rgb_color( 28,28,28 ));
    } // Avtk::Box* lfoBox
    { lfoSpeed = new Avtk::Dial(258, 165, 30, 30, "Speed");
      lfoSpeed->box(FL_OVAL_BOX);
    ...
    { filterBox = new Avtk::Box(184, 364, 148, 70);
      filterBox->box(FL_DOWN_BOX);
      filterBox->color(FL_BACKGROUND_COLOR);
      filterBox->selection_color(FL_BACKGROUND_COLOR);
      filterBox->labeltype(FL_NO_LABEL);
      filterBox->labelfont(0);
      filterBox->labelsize(14);
      filterBox->labelcolor(FL_FOREGROUND_COLOR);
      filterBox->align(Fl_Align(FL_ALIGN_CENTER));
      filterBox->when(FL_WHEN_RELEASE);
    ...
    { adsrBox = new Avtk::Box(353, 160, 148, 70);
      adsrBox->box(FL_DOWN_BOX);
      adsrBox->color(FL_BACKGROUND_COLOR);
      adsrBox->selection_color(FL_BACKGROUND_COLOR);
      adsrBox->labeltype(FL_NO_LABEL);
      adsrBox->labelfont(0);
      adsrBox->labelsize(14);
      adsrBox->labelcolor(FL_FOREGROUND_COLOR);
      adsrBox->align(Fl_Align(FL_ALIGN_CENTER));
      adsrBox->when(FL_WHEN_RELEASE);
      //adsrBox->color( fl_rgb_color( 28,28,28 ));
    } // Avtk::Box* adsrBox
    { sustain = new Avtk::Dial(427, 165, 30, 30, "S");
      sustain->box(FL_OVAL_BOX);
    ...
    { compBox = new Avtk::Box(351, 364, 98, 72);
      compBox->box(FL_DOWN_BOX);
      compBox->color(FL_BACKGROUND_COLOR);
      compBox->selection_color(FL_BACKGROUND_COLOR);
      compBox->labeltype(FL_NO_LABEL);
      compBox->labelfont(0);
      compBox->labelsize(14);
      compBox->labelcolor(FL_FOREGROUND_COLOR);
      compBox->align(Fl_Align(FL_ALIGN_CENTER));
      compBox->when(FL_WHEN_RELEASE);
      //compBox->color( fl_rgb_color( 28,28,28 ));
    } // Avtk::Box* compBox
    { compThres = new Avtk::Dial(404, 369, 30, 30, "Thres");
      compThres->box(FL_OVAL_BOX);
